...
$notify_email =  $email_Administrator;         //email address to which debug emails are sent to
...
connectDatabase(); // call to include/functions.php
/*
$Connect = @mysql_connect($DB_Server, $DB_Username, $DB_Password, FALSE, MYSQL_CLIENT_SSL)
